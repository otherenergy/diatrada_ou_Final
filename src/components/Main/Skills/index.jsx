        ...
        <div className="row">
          <div className="col-lg-5 valign">
            <div className="content md-mb50">
              ...
              <h2 className="mb-20 fw-800">162 Already <span className="gr-purple-red-text">completed works and still counting</span></h2>
              <p>We guide you through every step, from company establishment to ongoing consulting and auditing, ensuring seamless operations.</p>
