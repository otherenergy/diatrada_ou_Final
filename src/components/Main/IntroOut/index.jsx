        ...
        <div className="row">
          <div className="col-lg-6 valign">
            <div className="img wow fadeInLeft" data-wow-delay=".3s" data-wow-duration="2s">
              <img src="img/about/laptop.png" alt="" />
          ...
          <div className="col-lg-6 valign">
            <div className="cont">
              <h6 className="sub-title gr-purple-red-text inline">Build it beautiful</h6>
              <h4>The most exquisite agency for provide branding services.</h4>

              <div className="flex mt-50">
                <div className="item mr-30 wow fadeInUp" data-wow-delay=".1s">
                  <h4 className="fw-300 mb-10">320 +</h4>
                  <h6 className="mb-5">Perfect Prodects</h6>
                  <p>The most widely sought for agency in branding nowadays we design brand.</p>
                </div>
                <div className="item wow fadeInUp" data-wow-delay=".3s">
                  <h4 className="fw-300 mb-10">100%</h4>
                  <h6 className="mb-5">Positive Feedback</h6>
                  <p>The most widely sought for agency in branding nowadays we design brand.</p>
                </div>
              </div>
