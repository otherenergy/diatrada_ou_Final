          ...
          <div className="row">
            ...
            <div className="col-lg-6">
              <div className="copyrights d-flex justify-content-end">
                <p className="fz-13">© 2025 Diatrada is Proudly Powered by <span className="underline"><a rel="noreferrer" href="https://themeforest.net/user/themescamp" target="_blank">ThemesCamp</a></span></p>
              </div>
            </div>
          </div>
        </div>
